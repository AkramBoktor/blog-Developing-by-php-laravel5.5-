                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{route('post.single',['slug'=>$second_post->slug])}}">{{$second_post->title}}</a>{{$second_post->title}}</a>
                                    </h2>
                ...
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title ">
                                        <a href="{{route('post.single',['slug'=>$third_post->slug])}}">{{$third_post->title}}</a>{{$third_post->title}}</a>
                                    </h2>
...
<!--- Print Posts Belongs To Category -!-->
                    <div class="row">
...
<!--- Print Tutorial Belongs To Category ----!-->
                ...
                <div class="offers">
                    ...
                    <div class="row">
        @foreach($tutorial->posts()->orderBy('created_at','desc')->take(3)->get() as $tutorial)

                        <div class="case-item-wrap">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$tutorial->featured}}" alt="{{$tutorial->featured}}">
                                    </div>
                                    <h6 class="case-item__title"><a href="#">{{$tutorial->title}}</a></h6>
                                </div>
                            </div>
                @endforeach
